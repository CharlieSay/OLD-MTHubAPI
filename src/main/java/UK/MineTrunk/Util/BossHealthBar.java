...
public class BossHealthBar {
  public static final int ENTITY_ID = 1234;
	...
	public static void displayTextBar(String text, final Player player){
		...
		}.runTaskLater(UK.MineTrunk.Main.MainClass, 120L);
	}
		...
		new BukkitRunnable(){
			...
			public void run(){
				if((loadUp ? health < 300 : health > 0)){
					...
					}.runTaskLater(UK.MineTrunk.Main.MainClass, 40L);
					
					this.cancel();
				}
			}
		}.runTaskTimer(UK.MineTrunk.Main.MainClass, delay, delay);
	}
